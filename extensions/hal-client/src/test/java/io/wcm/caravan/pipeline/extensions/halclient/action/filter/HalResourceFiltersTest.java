...
import static io.wcm.caravan.pipeline.extensions.halclient.action.filter.HalResourceFilters.all;
import static io.wcm.caravan.pipeline.extensions.halclient.action.filter.HalResourceFilters.hasEmbedded;
import static io.wcm.caravan.pipeline.extensions.halclient.action.filter.HalResourceFilters.hasNonNull;
import static io.wcm.caravan.pipeline.extensions.halclient.action.filter.HalResourceFilters.hasPathNonNull;
